...
# allowed FX symbols
SYMBOLS = ['AUDCAD', 'AUDCHF', 'AUDJPY', 'AUDNZD', 'AUDUSD', 'CADCHF', 'CADJPY', 'CHFJPY', 'EURAUD', 'EURCAD', 'EURCHF', 'EURGBP', 'EURJPY', 'EURNZD', 'EURUSD', 'GBPAUD', 'GBPCAD', 'GBPCHF', 'GBPJPY', 'GBPNZD', 'GBPUSD', 'NOW', 'NZDCAD', 'NZDCHF', 'NZDJPY', 'NZDUSD', 'USDCAD', 'USDCHF', 'USDJPY', 'XAGUSD', 'XAUUSD','AUDCAD-', 'AUDCHF-', 'AUDJPY-', 'AUDNZD-', 'AUDUSD-', 'CADCHF-', 'CADJPY-', 'CHFJPY-', 'EURAUD-', 'EURCAD-', 'EURCHF-', 'EURGBP-', 'EURJPY-', 'EURNZD-', 'EURUSD-', 'GBPAUD-', 'GBPCAD-', 'GBPCHF-', 'GBPJPY-', 'GBPNZD-', 'GBPUSD-', 'NOW', 'NZDCAD-', 'NZDCHF-', 'NZDJPY-', 'NZDUSD-', 'USDCAD-', 'USDCHF-', 'USDJPY-', 'XAGUSD-', 'XAUUSD-']
# RISK FACTOR
...
def GetTradeInformation(update: Update, trade: dict, balance: float) -> None:
    ...
    if(trade['Symbol'] == 'XAUUSD' or trade['Symbol'] == 'XAUUSD-'):
        multiplier = 0.1

    elif(trade['Symbol'] == 'XAGUSD' or trade['Symbol'] == 'XAGUSD-'):
        multiplier = 0.001
